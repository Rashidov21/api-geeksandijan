"""
Django settings for geeks_api project.
...
ALLOWED_HOSTS = ['yourapp.pythonanywhere.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'geeks_api.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow unauthenticated access for public API
    ],
